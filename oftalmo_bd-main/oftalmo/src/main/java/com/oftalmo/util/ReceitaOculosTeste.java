...
public class ReceitaOculosTeste {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        ReceitaOculos receitaoculos = new ReceitaOculos("detalhamento", Date.valueOf("2000-01-01"), 3);
        receitaoculosdao.insertReceitaOculos(receitaoculos);

        //buscar por ID
        System.out.println("Busca id");
        receitaoculos = receitaoculosdao.selectReceitaOculos(3);
        System.out.println(receitaoculosdao.selectReceitaOculos(3));

        //update
        System.out.println("update");
        receitaoculos.setDetalhamento("detalhamento1");
        receitaoculos.setDtConsulta(Date.valueOf("2001-01-11"));
        receitaoculos.setIdConsultaMedica(3);
