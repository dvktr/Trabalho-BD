...
public class ObservacaoLaudoTeste {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        ObservacaoLaudo observacaolaudo = new ObservacaoLaudo("descricao", 3);
        observacaolaudodao.insertObservacaoLaudo(observacaolaudo);

        //buscar por ID
        System.out.println("Busca id");
        observacaolaudo = observacaolaudodao.selectObservacaoLaudo(2);
        System.out.println(observacaolaudodao.selectObservacaoLaudo(2));

        //update
        System.out.println("update");
        observacaolaudo.setDescricao("descricao1");
        observacaolaudo.setIdReceitaOculos(3);
